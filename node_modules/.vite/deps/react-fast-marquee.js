...
var require_dist = /* @__PURE__ */ __commonJS({ "node_modules/react-fast-marquee/dist/index.js": ((exports) => {
	...
	var Marquee = React.forwardRef(function Marquee$1({ style = {}, className = "", autoFill = false, play = true, pauseOnHover = false, pauseOnClick = false, direction = "left", speed = 50, delay = 0, loop = 0, gradient = false, gradientColor = "white", gradientWidth = 200, onFinish, onCycleComplete, onMount, children }, ref) {
		...
		const calculateWidth = React.useCallback(() => {
			if (marqueeRef.current && containerRef.current) {
				...
				let containerWidth$1 = containerRect.width;
				let marqueeWidth$1 = marqueeRect.width;
				if (direction === "up" || direction === "down") {
					containerWidth$1 = containerRect.height;
					marqueeWidth$1 = marqueeRect.height;
				}
				if (autoFill && containerWidth$1 && marqueeWidth$1) setMultiplier(marqueeWidth$1 < containerWidth$1 ? Math.ceil(containerWidth$1 / marqueeWidth$1) : 1);
				else setMultiplier(1);
				setContainerWidth(containerWidth$1);
				setMarqueeWidth(marqueeWidth$1);
			}
		}, [
			autoFill,
			containerRef,
		...
		const multiplyChildren = React.useCallback((multiplier$1) => {
			return [...Array(Number.isFinite(multiplier$1) && multiplier$1 >= 0 ? multiplier$1 : 0)].map((_, i) => React__default["default"].createElement(React.Fragment, { key: i }, React.Children.map(children, (child) => {
